...
class CNNCaptchaRecognition:
    ...
    def __init__(self):
        ...
        self.w_d = tf.Variable(tf.truncated_normal([512, 1024], stddev=0.1))
    ...
    def forward(self):
        ...
        # ys: [100, 128, 512] --> y: [100, 512]
        y = ys[:, -1, :]

        # Fully connected layer
        dense = tf.nn.relu(tf.add(tf.matmul(y, self.w_d), self.b_d))
